      ...
      <div className="mb-16">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <div className="card-cyber text-center">
            ...
            <p className="text-sm text-gray-400">Connect your Solana wallet securely</p>
          </div>

          <div className="card-cyber text-center">
            <div className="text-5xl mb-4">🔍</div>
            <h3 className="text-xl font-bold mb-2 text-neon-pink">2. Scan</h3>
            <p className="text-sm text-gray-400">We scan for empty SPL token accounts</p>
          </div>

          <div className="card-cyber text-center">
            <div className="text-5xl mb-4">✅</div>
            <h3 className="text-xl font-bold mb-2 text-neon-cyan">3. Select</h3>
            <p className="text-sm text-gray-400">Choose accounts to close</p>
          </div>

          <div className="card-cyber text-center">
            <div className="text-5xl mb-4">💰</div>
            <h3 className="text-xl font-bold mb-2 text-neon-green">4. Claim</h3>
            <p className="text-sm text-gray-400">Receive your SOL instantly</p>
          </div>
        </div>
      </div>
